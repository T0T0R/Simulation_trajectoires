...
public class Cible extends JPanel {
	...
	protected int tempsMesure = 0; //Etape a laquelle on recupere les positions Y et Z des electrons

	protected double YMesure = 0.5;//Centrage des axes par rapport au faisceau
